...
* Supports Android 12+
* Supports mounting multiple devices at once
...
AIM does not need to run in the background. Once configured, the mouned images remain available until they're explicitly disabled or the device is rebooted
